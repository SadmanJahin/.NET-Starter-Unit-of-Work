...
using WebAPIStarter.Controllers.v1;
...
builder.Services.AddAutoregister(typeof(TestService).Assembly);
builder.Services.AddAutoregister(typeof(TestRepository).Assembly);
#endregion
